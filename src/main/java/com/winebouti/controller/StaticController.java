...
public class StaticController {
	...
	@GetMapping("md/cook")
	public String mdCook() { return BASE_PATH + "md_cook.tiles"; }
	
	
	@GetMapping("md/hello")
	public String mdhello() { return BASE_PATH + "md_hello.tiles"; }
	
	
	@GetMapping("md/wine")
	public String mdwine() { return BASE_PATH + "md_wine.tiles"; }
