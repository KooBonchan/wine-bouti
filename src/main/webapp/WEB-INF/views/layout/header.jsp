...
<div class="wrap">
	<nav class="menu">
		...
		<ul class="navi">
			<li><a href="#">상품</a>
				<ul class="submenu">
					<li><a href="<c:url value='/product/red-wine' />">레드와인</a></li>
					<!-- 레드 와인 페이지로 이동 -->
					<li><a href="<c:url value='/product/white-wine' />">화이트</a></li>
					<!-- 화이트 와인 페이지로 이동 -->
					<li><a href="<c:url value='/product/sparkle-wine' />">스파클링</a></li>
					<!-- 스파클링 와인 페이지로 이동 -->
		...
		<div class="icon-wrapper">
			<sec:authorize access="isAnonymous()">
				<div class="iconlogin">
					...
					<img
						src="<c:url value='/resources/images/icon/login.png'/>"
						alt="로그인 아이콘" />
					</a>
				</div>
			</sec:authorize>
			<sec:authorize access="isAuthenticated()">
				...
				<div class="iconcart">
					...
					<img src="<c:url value='/resources/images/icon/cart.png'/>"
						alt="0" />
						<c:if test="${not empty cartDTO and not empty cartDTO.itemDetail}">
						<span class="cart-badge"><c:out value="${cartDTO.itemDetail.size()}" /></span>
						</c:if>
					</a>
				</div>
